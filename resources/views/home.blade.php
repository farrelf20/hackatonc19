            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{url('api/covid')}}">Daftar Covid19</a>
                        <a class="collapse-item" href="{{url('api/rujukan')}}">Daftar RS Rujukan</a>
                        <a class="collapse-item" href="{{url('vaksin')}}">Form Pendaftaran Vaksin</a>
                    </div>
                </div>
            </li>
